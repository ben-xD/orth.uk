...
[TalkDash](https://talkdash.orth.uk/) is a timer app for events. Speakers see a large timer that expands to fill the window. Event hosts can send messages to speakers. You can tell speakers how much time they had left, and send messages to speakers without having to interrupt them or block the audience. I was previously showing my mobile phone to the speaker using an Android app, but it was too small and speaker couldn't see it.
