...
Here's what I use:
- **Favourite resources:** Time, documentation, getting-started guides, OReilly books, WWDC, Hacker News, YouTube
- **Learning style:** Learns best by building projects, transitioning to books and videos when lack of knowledge slows me down enough.
- **Repositories:** See [GitHub](https://github.com/ben-xD), here's 4 you might be interested in: [Anonymous video calling app](https://github.com/ben-xD/Club), [Peer to peer restaurant app](https://github.com/CheffreshX/cheffresh), [Carbon footprint scanner](https://github.com/ben-xD/foodprint), [macOS Hackintosh settings](https://github.com/ben-xD/macOS-ryzen)
