...
- **Email:** `gpditmrv@duck.com` (check back to see my latest disposable email), or
- **Feedback form:** Submit the feedback form with your message.

### Talks/workshops I've given 🎙 {#talks}

- **Talk:** Preparing for [CyberCenturion](https://www.stem.org.uk/secondary/enrichment/competitions/cyber-centurion) (links: [slides](https://cybercenturion.pages.dev/#/))
- **Talk:** Adding offline support to Flutter apps, at [DevFest London 2022](https://www.devfest-uki.com/) (links: [slides](https://orth.uk/workshops/adding-offline-to-flutter-slides/), [demo app](https://banananator.pages.dev/))
