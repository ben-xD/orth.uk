...
1. when I'm **learning and investing** in myself, and 
2. when solving problems for people by **simplifying and encapsulating complexity**.
...
- [**CV**](https://orth.uk/cv.pdf)
  - for a MS Word template for your own CV, download [firstname-lastname-cv.docx](https://orth.uk/firstname-lastname-cv.docx).
...
I am vegan 🥕, love animals and this planet (nature, outdoors). Contact me if you have similar interests or are solving solve interesting and important problems, I'd love to help.
...
```dart
if (visitor.isInterestedInBuildingCoolThings || visitor.isInterestedInSolvingImportantIssues) {
  final transport = new SmtpTransport(options);
  final envelope = Envelope()
    ..from = 'you@domain.com'
    ..from = 'Orth.uk Visitor'
    ..recipients = [bensEmailAddress]
    ..subject = 'Hey 👋'
    ..text = "How's it going? 😃";
  
  await transport.send(envelope)
  print("Email sent to $bensEmailAddress")
}
```
