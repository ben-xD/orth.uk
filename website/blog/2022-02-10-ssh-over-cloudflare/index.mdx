...
- `ssh phanteks`
## Conclusion 💌
- Maybe there is a way to automate this so all machines I use in the future will be set up automatically. Thankfully, I am not building a server farm in home, so this is a very low priority.
