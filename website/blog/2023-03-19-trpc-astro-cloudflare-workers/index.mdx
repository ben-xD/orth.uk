...
## Summary 📒
I'm currently trying **tRPC with Astro on Cloudflare Pages**, without a single Cloudflare Pages Function. That is to say, I only have 1 worker: a **fat worker**. Let me know if you have any questions.
