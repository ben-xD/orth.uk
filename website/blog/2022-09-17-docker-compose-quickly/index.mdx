...
## More reading 👀
- Docker images don't have the Linux kernel in them, they share the one from the Host. Running Docker on macOS is more resource intensive than on a Linux host, because 
