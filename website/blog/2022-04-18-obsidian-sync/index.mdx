---
title: 'Syncing Obsidian Vault on macOS and Android, using git, for free'
authors: ben
slug: 'obsidian-sync'
description: 'How to sync your Obsidian Vault on macOS and Android using git, for free'
tags:
  - obsidian
---
...
- **Not for iOS:** This guide doesn't work for iOS, for the same reasons a lot of things don't work on iOS. 
